# prefix form : https://github.com/eopXD/SHA1collide/blob/master/collide.py
...
original_pdf = input("filename : ")

if original_pdf:
	with open(original_pdf, "rb") as f:contenu = f.read()
	with open("pdf_prefixed_A.pdf", "wb") as f:f.write(prefix1);f.write(contenu)
	with open("pdf_prefixed_B.pdf", "wb") as f:f.write(prefix2); f.write(contenu)
	print("PDF GENERER AVEC SUCCès")
else:
	with open("file1.bin", "wb") as f:f.write(prefix1)
	with open("file2.bin", "wb") as f:f.write(prefix2)
	print("FILE GENERER AVEC SUCCès")